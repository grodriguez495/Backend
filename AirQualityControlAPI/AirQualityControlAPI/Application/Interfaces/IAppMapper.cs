...
namespace AirQualityControlAPI.Application.Interfaces
{
    public interface IAppMapper
    {
        ...
        /// <typeparam name="TDestination">Destination type to create</typeparam>
        /// <returns>Mapped destination object</returns>
        TDestination Map<TDestination>(object source, string key, object value);
        ...
        /// <typeparam name="TDestination">Destination type to create</typeparam>
        /// <returns>Mapped destination object</returns>
        TDestination Map<TDestination>(object source, params (string key, object value)[] parameters);
        ...
        /// <typeparam name="TDestination">Destination type to create</typeparam>
        /// <returns>Mapped destination object</returns>
        TDestination Map<TDestination>(object source, IDictionary<string, object> parameters);
